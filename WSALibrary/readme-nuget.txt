...
nuget pack WSALibrary\WSALibrary.csproj -IncludeReferencedProjects -Version 1.0.7 -Properties Configuration=Release

// the same, when necessary to support multi target frameworks
// dotnet pack wsalibrary.csproj -c release -p:packageversion=1.0.7 -p:nuspecfile=wsalibrary.nuspec

// how to make nuget push:
nuget push SimpleWSA.WSALibrary.1.0.7.nupkg 43B55E1D-BE70-4D3E-88A0-0485F83E4F31 -src https://cms.navitas.nl/nuget/api/v2/package
